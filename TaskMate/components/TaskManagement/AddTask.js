...
const CreateTaskScreen = () => {
    ...
    return (
        ...
        >
            ...
            <Text style={[styles.label, { color: isDark ? "#fff" : "#000" }]}>Deadline</Text>
            <TouchableOpacity
                style={[
                    styles.input,
                    { backgroundColor: isDark ? "#1e1e1e" : "#f2f2f2", justifyContent: "center" },
                ]}
                onPress={() => setShowDatePicker(true)}
            >
                <Text style={{ color: isDark ? "#fff" : "#000" }}>{deadline.toDateString()}</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.createButton} onPress={handleTaskCreation}>
