        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity onPress={() => setShowStartDatePicker(true)}>
              <View style={[styles.inputContainer, startDateError ? styles.inputError : null]}>
                <TextInput
            ...
            <TouchableOpacity onPress={() => setShowEndDatePicker(true)}>
              <View style={[styles.inputContainer, endDateError ? styles.inputError : null]}>
                <TextInput
                  style={styles.inputWithIcon}
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Calendar
              ...
              minDate={moment(selectedGoal?.Start_Date).add(1, "day").format("YYYY-MM-DD")}
              theme={{
                backgroundColor: '#fff',
                calendarBackground: '#fff',
                textSectionTitleColor: '#555',
